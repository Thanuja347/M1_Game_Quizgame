...
int main()
    ...
    system("cls");
     ...
     switch(r1)
        ...
        case 2:
		printf("\n\n\nwhich crop is growm a lot in India?");
		printf("\n\nA.Corn\t\tB.Wheat\n\nC.Rice\t\tD.Maize");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");count++;
			getch();
        ...
        case 3:
		printf("\n\n\nWhich is known as National Animal of India?");
		printf("\n\nA.Polar Bear\t\tB.Tiger\n\nC.Elephant\t\tD.Chimpanzee");
		if (toupper(getch())=='B')
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
...
game:
     ...
     switch(r)
		...
		if (toupper(getch())=='B' )
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is B.Boron");goto score;
		       getch();
		       break;}

        case 7:
		printf("\n\n\nWho wrote the National Anthem?");
		printf("\n\nA.Modi\t\tB.Nehru\n\nC.Gandhi\t\tD.Rabindranath Tagore");
		if (toupper(getch())=='D')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		else
		       {printf("\n\nWrong!!! The correct answer is D.Rabindranath Tagore");getch();
		       goto score;
		       break;}
		...
		printf("\n\nA.Valmiki\t\tB.Lal Gopal Subedi\n\nC.B.P. Koirala\t\tD.Khagendra Sangraula");
		if (toupper(getch())=='A')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		else
		       {printf("\n\nWrong!!! The correct answer is A.Valmiki");getch();
		       break;goto score;}
